    ...
    void applyMatcap(inout float4 finalColor, inout float3 matcapEmission)
    {
        ...
        blendMatcap(finalColor, (0.137 /*_MatcapAdd*/), (0.064 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), matcap, matcapMask, matcapEmission, (0.0 /*_MatcapEmissionStrength*/)
        #ifdef POI_LIGHTING
        ...
        , (4.0 /*_BlackLightMaskMatcap*/)
            ...
            #if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
                matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap2, _MainTex, TRANSFORM_TEX(matcapUV2, _Matcap2)) * float4(0.944,0.8442019,0.812784,1);
            #else
                matcap2 = float4(0.944,0.8442019,0.812784,1);
            #endif
