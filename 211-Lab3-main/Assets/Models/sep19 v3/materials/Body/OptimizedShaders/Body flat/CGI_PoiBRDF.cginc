...
bool DoesReflectionProbeExist()
{
    ...
    return probeExists && !(1.0 /*_BRDFForceFallback*/);
}
...
void poiBRDF(inout float4 finalColor, const float4 finalColorBeforeLighting)
{
    ...
    float reflectance = metallicGlossMap.g * (0.189 /*_BRDFReflectance*/);
    float roughness = max(1 - ((0.661 /*_BRDFGlossiness*/) * metallicGlossMap.a), getGeometricSpecularAA(poiMesh.normals[1]));
    finalColor.rgb *= lerp(1, 1 - metallic, (0.0 /*_BRDFReflectionsEnabled*/));
    ...
    float3 specular = indirectSpecular * (0.0 /*_BRDFReflectionsEnabled*/) * metallicTintMask.a * metallicTintMask.rgb * poiLight.occlusion + (directSpecular + vDirectSpecular) * (1.0 /*_BRDFSpecularEnabled*/) * spcularTintMask.a * spcularTintMask.rgb;
