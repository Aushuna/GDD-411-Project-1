...
void calculateNormals(inout half3 detailMask)
{
	half3 mainNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_BumpMap, _MainTex, poiMesh.uv[(0.0 /*_BumpMapUV*/)], float4(0,0,0,0)), (0.0 /*_BumpScale*/));
		...
		if ((0.2 /*_DetailNormalMapScale*/) > 0)
		{
			#if defined(PROP_DETAILNORMALMAP) || !defined(OPTIMIZER_ENABLED)
				half3 detailNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN(_DetailNormalMap, _MainTex, poiMesh.uv[(0.0 /*_DetailNormalMapUV*/)], float4(0,0,0,0)), (0.2 /*_DetailNormalMapScale*/) * detailMask.g);
