...
void applyDecals(inout float4 albedo, inout float3 decalEmission)
{
    ...
    decalScale = float4(1,1,0,0);
        ...
        #endif
        uv = decalUV((0.0 /*_DecalTextureUV*/), float4(0.5,0.5,0,0), (0.0 /*_DecalRotation*/) + decalRotation, (0.0 /*_DecalRotationSpeed*/), decalScale, (0.0 /*_Decal0Depth*/));
    ...
    decalColor.a *= applyTilingClipping((0.0 /*_DecalTiled*/), uv) * decalMask.r;
    ...
    #endif
    albedo.rgb = lerp(albedo.rgb, customBlend(albedo.rgb, decalColor.rgb, (0.0 /*_DecalBlendType*/)), decalColor.a * saturate(_DecalBlendAlpha + audioLinkDecalAlpha0));
    ...
    decalEmission += decalColor.rgb * decalColor.a * max((0.0 /*_DecalEmissionStrength*/) + audioLinkDecalEmission0, 0);
        ...
        decalRotation = 0;
            ...
            #endif
            uv = decalUV((0.0 /*_DecalTexture1UV*/), float4(0.5,0.5,0,0), (0.0 /*_DecalRotation1*/) + decalRotation, (0.0 /*_DecalRotationSpeed1*/), decalScale, (0.0 /*_Decal1Depth*/));
            decalColor = POI2D_SAMPLER_PAN(_DecalTexture1, _MainTex, uv, float4(0,0,0,0)) * float4(1,1,1,1);
        #else
            uv = decalUV((0.0 /*_DecalTexture1UV*/), float4(0.5,0.5,0,0), (0.0 /*_DecalRotation1*/) + decalRotation, (0.0 /*_DecalRotationSpeed1*/), decalScale, (0.0 /*_Decal1Depth*/));
            decalColor = float4(1,1,1,1);
        #endif
        decalColor.rgb = decalHueShift((0.0 /*_DecalHueShiftEnabled1*/), decalColor.rgb, (0.0 /*_DecalHueShift1*/), (0.0 /*_DecalHueShiftSpeed1*/));
        decalColor.a *= applyTilingClipping((0.0 /*_DecalTiled1*/), uv) * decalMask.g;
        float audioLinkDecalAlpha1 = 0;
        #ifdef POI_AUDIOLINK
            audioLinkDecalAlpha1 = lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal1AlphaBand*/)]) * poiMods.audioLinkTextureExists;
        #endif
        albedo.rgb = lerp(albedo.rgb, customBlend(albedo.rgb, decalColor.rgb, (2.0 /*_DecalBlendType1*/)), decalColor.a * saturate(_DecalBlendAlpha1 + audioLinkDecalAlpha1));
        float audioLinkDecalEmission1 = 0;
        #ifdef POI_AUDIOLINK
            audioLinkDecalEmission1 = lerp(float4(0,0,0,0).x, float4(0,0,0,0).y, poiMods.audioLink[(0.0 /*_AudioLinkDecal1EmissionBand*/)]) * poiMods.audioLinkTextureExists;
        #endif
        decalEmission += decalColor.rgb * decalColor.a * max((0.0 /*_DecalEmissionStrength1*/) + audioLinkDecalEmission1, 0);
    #endif
