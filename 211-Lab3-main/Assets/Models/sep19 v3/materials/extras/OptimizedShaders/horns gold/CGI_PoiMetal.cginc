    ...
    void ApplyMetallics(inout float4 finalColor, in float4 albedo)
    {
            ...
            smoothnessMap *= (0.908 /*_Smoothness*/);
            ...
            finalColor.rgb += reflecty_lighty_boy_uwu_var_2 * reflection.rgb * fresnelRelflection(albedo) * float4(1,0.6486544,0,1) * tintMap.rgb * tintMap.a;
        #endif
    }
