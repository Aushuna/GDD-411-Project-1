...
void calculateBasePassLightMaps()
{
        ...
        shadowStrength = 1;
        #ifndef OUTLINE
            shadowStrength = POI2D_SAMPLER_PAN(_LightingShadowMask, _MainTex, poiMesh.uv[(0.0 /*_LightingShadowMaskUV*/)], float4(0,0,0,0)) * (0.5 /*_ShadowStrength*/);
        #else
        ...
        switch((0.0 /*_LightingRampType*/))
        {
            ...
            case 1: // Math Gradient
            {
                ...
                if ((0.0 /*_LightingIgnoreAmbientColor*/))
                {
                    poiLight.finalLighting = lerp((directLighting * shadowColor * poiLight.occlusion), (directLighting), saturate(poiLight.rampedLightMap + 1 - (0.5 /*_ShadowStrength*/)));
                }
                else
                {
                    poiLight.finalLighting = lerp((indirectLighting * shadowColor * poiLight.occlusion), (directLighting), saturate(poiLight.rampedLightMap + 1 - (0.5 /*_ShadowStrength*/)));
                }
            }
            break;
            case 2:
        ...
        if ((0.0 /*_LightingMode*/) == 2) // Wrapped
        {
            ...
            poiLight.finalLighting = (poiLight.indirectLighting + poiLight.directLighting) * saturate(poiLight.rampedLightMap + 1 - (0.5 /*_ShadowStrength*/));
        }
        if (!(0.0 /*_LightingUncapped*/))
        {
...
void applyShadeMaps(inout float4 albedo)
{
    ...
    if ((0.0 /*_LightingRampType*/) == 2)
    {
        ...
        float firstColorFeatherStep = (0.5 /*_ShadeColor_Step*/) - (0.0 /*_1st2nd_Shades_Feather*/);
        ...
        float firstSecondShadowMask = saturate(1 - ((poiLight.lightMap) - firstColorFeatherStep) / ((0.5 /*_ShadeColor_Step*/) - firstColorFeatherStep) * (shadowMask));
