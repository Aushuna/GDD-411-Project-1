...
UnityIndirect CreateIndirectLight(float3 normal)
{
    ...
    indirectLight.specular = 0;
        ...
        {
            occlusion = lerp(1, POI2D_SAMPLER_PAN(_LightingAOTex, _MainTex, poiMesh.uv[(0.0 /*_LightingAOTexUV*/)], float4(0,0,0,0)).r, (0.0 /*_AOStrength*/));
        }
...
void calculateBasePassLightMaps()
{
        ...
        shadowStrength = 1;
        #ifndef OUTLINE
            shadowStrength = POI2D_SAMPLER_PAN(_LightingShadowMask, _MainTex, poiMesh.uv[(0.0 /*_LightingShadowMaskUV*/)], float4(0,0,0,0)) * (0.529 /*_ShadowStrength*/);
        #else
        ...
        switch((0.0 /*_LightingRampType*/))
        {
            ...
            case 1: // Math Gradient
            {
                ...
                if ((0.0 /*_LightingIgnoreAmbientColor*/))
                {
                    poiLight.finalLighting = lerp((directLighting * shadowColor * poiLight.occlusion), (directLighting), saturate(poiLight.rampedLightMap + 1 - (0.529 /*_ShadowStrength*/)));
                }
                else
                {
                    poiLight.finalLighting = lerp((indirectLighting * shadowColor * poiLight.occlusion), (directLighting), saturate(poiLight.rampedLightMap + 1 - (0.529 /*_ShadowStrength*/)));
                }
            }
            break;
            case 2:
        ...
        if ((0.0 /*_LightingMode*/) == 2) // Wrapped
        {
            ...
            poiLight.finalLighting = (poiLight.indirectLighting + poiLight.directLighting) * saturate(poiLight.rampedLightMap + 1 - (0.529 /*_ShadowStrength*/));
        }
        if (!(0.0 /*_LightingUncapped*/))
        {
