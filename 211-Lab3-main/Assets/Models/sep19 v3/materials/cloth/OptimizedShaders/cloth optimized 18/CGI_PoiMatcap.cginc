    ...
    void applyMatcap(inout float4 finalColor, inout float3 matcapEmission)
    {
        ...
        half2 matcapUV = half2(dot(worldViewRight, poiMesh.normals[(1.0 /*_MatcapNormal*/)]), dot(worldViewUp, poiMesh.normals[(1.0 /*_MatcapNormal*/)])) * (0.5 /*_MatcapBorder*/) + 0.5;
        #if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
        ...
        blendMatcap(finalColor, (0.0 /*_MatcapAdd*/), (0.346 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), matcap, matcapMask, matcapEmission, (0.0 /*_MatcapEmissionStrength*/)
        #ifdef POI_LIGHTING
        ...
        , (4.0 /*_BlackLightMaskMatcap*/)
            ...
            #if defined(PROP_MATCAP2) || !defined(OPTIMIZER_ENABLED)
                matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap2, _MainTex, TRANSFORM_TEX(matcapUV2, _Matcap2)) * float4(1,0.8065753,0.514151,1);
            #else
                matcap2 = float4(1,0.8065753,0.514151,1);
            #endif
            ...
            blendMatcap(finalColor, (1.0 /*_Matcap2Add*/), (0.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), matcap2, matcap2Mask, matcapEmission, (0.0 /*_Matcap2EmissionStrength*/)
            #ifdef POI_LIGHTING
