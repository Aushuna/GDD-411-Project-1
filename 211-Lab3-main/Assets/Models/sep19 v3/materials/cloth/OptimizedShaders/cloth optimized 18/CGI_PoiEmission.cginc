...
{
    float3 emission0 = 0;
    float emissionStrength0 = (0.23 /*_EmissionStrength*/);
    ...
    float glowInTheDarkMultiplier0 = calculateGlowInTheDark((0.0 /*_GITDEMinLight*/), (1.0 /*_GITDEMaxLight*/), (1.0 /*_GITDEMinEmissionMultiplier*/), (0.0 /*_GITDEMaxEmissionMultiplier*/), (0.0 /*_EnableGITDEmission*/), (0.0 /*_GITDEWorldOrMesh*/));
        ...
        {
            emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(0,0,0,0)).rgb * lerp(1, baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * float4(2,0.6196079,0.07058824,1).rgb;
        }
        else
        {
            emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (5.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * float4(2,0.6196079,0.07058824,1).rgb;
        }
    #else
        emissionColor0 = lerp(1, baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * float4(2,0.6196079,0.07058824,1).rgb;
    #endif
    ...
    emissionColor0 = hueShift(emissionColor0, frac((0.0 /*_EmissionHueShift*/) + (0.0 /*_EmissionHueShiftSpeed*/) * _Time.x) * (0.0 /*_EmissionHueShiftEnabled*/));
        ...
        if ((4.0 /*_BlackLightMaskEmission*/) != 4)
        {
            emissionMask0 *= blackLightMask[(4.0 /*_BlackLightMaskEmission*/)];
        }
    #endif
    ...
    emission0 = emissionStrength0 * emissionColor0;
        ...
        if ((0.0 /*_DissolveEmissionSide*/) != 2)
        {
            emission0 *= lerp(1 - dissolveAlpha, dissolveAlpha, (0.0 /*_DissolveEmissionSide*/));
        }
    #endif
    float3 emission1 = 0;
