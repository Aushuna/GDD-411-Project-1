...
void applyDecals(inout float4 albedo, inout float3 decalEmission)
{
    ...
    decalScale = float4(1,1.12,0,0);
        ...
        #endif
        uv = decalUV((0.0 /*_DecalTextureUV*/), float4(0.75,0.18,0,0), (220.8 /*_DecalRotation*/) + decalRotation, (0.0 /*_DecalRotationSpeed*/), decalScale, (0.0 /*_Decal0Depth*/));
    ...
    #endif
    albedo.rgb = lerp(albedo.rgb, customBlend(albedo.rgb, decalColor.rgb, (6.0 /*_DecalBlendType*/)), decalColor.a * saturate((1.0 /*_DecalBlendAlpha*/) + audioLinkDecalAlpha0));
    ...
    #endif
    decalEmission += decalColor.rgb * decalColor.a * max((0.39 /*_DecalEmissionStrength*/) + audioLinkDecalEmission0, 0);
