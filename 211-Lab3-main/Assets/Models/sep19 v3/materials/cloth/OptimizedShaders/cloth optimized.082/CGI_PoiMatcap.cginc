    ...
    void applyMatcap(inout float4 finalColor, inout float3 matcapEmission)
    {
        ...
        #if defined(PROP_MATCAP) || !defined(OPTIMIZER_ENABLED)
            matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(1,0.8560471,0.126,1);
        #else
            matcap = float4(1,0.8560471,0.126,1);
        #endif
        ...
        blendMatcap(finalColor, (0.0 /*_MatcapAdd*/), (1.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), matcap, matcapMask, matcapEmission, (0.0 /*_MatcapEmissionStrength*/)
        #ifdef POI_LIGHTING
