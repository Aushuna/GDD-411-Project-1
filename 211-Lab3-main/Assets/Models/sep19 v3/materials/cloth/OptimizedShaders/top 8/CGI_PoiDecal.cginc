...
void applyDecals(inout float4 albedo, inout float3 decalEmission)
{
    ...
    decalScale = float4(1.5,1.5,0,0);
        ...
        #endif
        uv = decalUV((0.0 /*_DecalTextureUV*/), float4(0.51,0.25,0,0), (0.0 /*_DecalRotation*/) + decalRotation, (0.0 /*_DecalRotationSpeed*/), decalScale, (0.0 /*_Decal0Depth*/));
