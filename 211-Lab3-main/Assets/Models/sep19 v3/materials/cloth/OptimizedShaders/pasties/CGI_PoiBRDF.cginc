...
void poiBRDF(inout float4 finalColor, const float4 finalColorBeforeLighting)
{
    ...
    float reflectance = metallicGlossMap.g * (0.605 /*_BRDFReflectance*/);
    float roughness = max(1 - ((0.67 /*_BRDFGlossiness*/) * metallicGlossMap.a), getGeometricSpecularAA(poiMesh.normals[1]));
