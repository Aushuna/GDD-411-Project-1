...
float4 frag(v2f i, uint facing: SV_IsFrontFace): SV_Target
{
	...
	**********************************************************************/
	...
	#endif
	float4 mainTexture = UNITY_SAMPLE_TEX2D(_MainTex, TRANSFORM_TEX(poiMesh.uv[(1.0 /*_MainTextureUV*/)], _MainTex) + _Time.x * float4(0,0,0,0));
	half3 detailMask = 1;
	...
	**********************************************************************/
		...
		#ifdef POI_SPECULAR
			meta.SpecularColor = poiLight.color.rgb * float4(0.8018868,0.8018868,0.8018868,1).rgb * lerp(1, albedo.rgb, (0.0 /*_SpecularMetallic*/)) * float4(0.8018868,0.8018868,0.8018868,1).a;
		#else
