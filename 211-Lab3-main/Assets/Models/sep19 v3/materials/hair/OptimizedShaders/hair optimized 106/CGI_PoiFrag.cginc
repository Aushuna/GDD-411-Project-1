...
float4 frag(v2f i, uint facing: SV_IsFrontFace): SV_Target
{
	...
	**********************************************************************/
		...
		#ifdef POI_SPECULAR
			meta.SpecularColor = poiLight.color.rgb * float4(0.01886791,0.01886791,0.01886791,1).rgb * lerp(1, albedo.rgb, (0.0 /*_SpecularMetallic*/)) * float4(0.01886791,0.01886791,0.01886791,1).a;
		#else
